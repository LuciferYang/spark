...
import org.apache.spark.sql.catalyst.expressions.{Alias, And, Attribute, AttributeMap, BinaryArithmetic, BinaryComparison, Expression, IsNotNull, IsNull, Literal, NamedExpression, Or, UnaryExpression, Unevaluable}
...
class PlanMerger extends Logging {
  ...
  private def getCost(e: Expression): Double = e match {
    ...
    case _: BinaryComparison | _: BinaryArithmetic |
        _: And | _: Or | _: IsNull | _: IsNotNull =>
