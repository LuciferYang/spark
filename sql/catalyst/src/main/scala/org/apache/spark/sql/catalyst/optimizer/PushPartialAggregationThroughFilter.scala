 ...
 * boundary. Implements Modi et al. section 4.2's "push gamma below select (sigma): extend keys
 ...
 *     Filter(p,
 *       PartialAggregate(g U p.references,
 *                        g U p.references U partial_aliases,
 *                        child))
 * }}}
 *
...
object PushPartialAggregationThroughFilter extends Rule[LogicalPlan] {
  ...
  /**
   * Extended grouping = original grouping U predicate's referenced attributes,
