...
class MergeSubplansSuite extends PlanTest {
  ...
  val testRelation2 = LocalRelation(Symbol("d").int, Symbol("e").int)
  ...
  test("Do not merge different aggregate implementations") {
    ...
    val subquery3 = ScalarSubquery(testRelation
      .groupBy(Symbol("b"))(collectList(Symbol("a")).as("collectlist_a")))
    val subquery4 = ScalarSubquery(testRelation
      .groupBy(Symbol("b"))(collectSet(Symbol("a")).as("collectset_a")))
    ...
    val objectHashAggregates = testRelation
      .groupBy(Symbol("b"))(
        collectList(Symbol("a")).as("collectlist_a"),
        collectSet(Symbol("a")).as("collectset_a"))
      .select(CreateNamedStruct(Seq(
