...
import org.apache.spark.sql.catalyst.expressions.{Add, Alias, Attribute, AttributeMap, AttributeReference, Cast, Divide, EvalMode, GreaterThan, Literal, NumericEvalContext, Rand, Substring}
