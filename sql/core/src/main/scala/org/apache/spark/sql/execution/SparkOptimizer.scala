...
import org.apache.spark.sql.execution.datasources.v2.{GroupBasedRowLevelOperationScanPlanning, OptimizeMetadataOnlyDeleteFromTable, V2ScanPartitioningAndOrdering, V2ScanRelationPruneColumns, V2ScanRelationPushDown, V2Writes}
...
class SparkOptimizer(
  ...
  override def defaultBatches: Seq[Batch] = flattenBatches(Seq(
    ...
    Batch("V2ScanRelationPruneColumns", Once, V2ScanRelationPruneColumns),
