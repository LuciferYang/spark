...
object SqlAndConnectCompatibilityCheck {
  ...
  def main(args: Array[String]): Unit = {
    ...
    checkMiMaCompatibility(clientJar, sqlJar)
    checkDatasetApiCompatibility(clientJar, sqlJar)
  }
   ...
   * the client classes.
   */
  private def checkMiMaCompatibility(clientJar: File, sqlJar: File): Unit = {
  ...
  private def checkDatasetApiCompatibility(clientJar: File, sqlJar: File): Unit = {
