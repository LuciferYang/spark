...
object Constants {
  ...
  val DRIVER_CREDENTIALS_CA_CERT_PATH: String =
  ...
  val DRIVER_CREDENTIALS_CLIENT_KEY_PATH: String =
  ...
  val DRIVER_CREDENTIALS_CLIENT_CERT_PATH: String =
  ...
  val DRIVER_CREDENTIALS_OAUTH_TOKEN_PATH: String =
  ...
  val SPARK_CONF_PATH: String = s"$SPARK_CONF_DIR_INTERNAL/$SPARK_CONF_FILE_NAME"
